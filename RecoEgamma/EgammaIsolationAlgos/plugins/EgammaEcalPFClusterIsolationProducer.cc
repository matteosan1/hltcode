...
void EgammaEcalPFClusterIsolationProducer<T1>::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  ////std::cout << "RECHIT COLLECTION" << std::endl;
  //edm::Handle<EcalRecHitCollection> hitEBH, hitEEH;
  //iEvent.getByLabel("ecalRecHit","EcalRecHitsEB", hitEBH);
  //iEvent.getByLabel("ecalRecHit","EcalRecHitsEE", hitEEH);
  //
  ...
  //    //std::cout << (int)recHit->id() << " " << recHit->energy() << std::endl;
  //  }
  //}
  //
